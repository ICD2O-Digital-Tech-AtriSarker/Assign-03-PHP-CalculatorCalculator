<?php
  if(isset($_POST['submit'])) 
  {
    ...
    $fstring = '
    <div id="mainDiv"><h3>Area+Perimeter of a Regular |n|-sided Polygon</h3><form id="calculateForm"><table><tr><td><label for="sideLengthInput">Enter side length (cm): </label><input type="number" step="0.001" min="0" id="sideLengthInput" name="sideLengthInput"></td><td><canvas id="polygonDisplay" width="100%" height="auto"></canvas></td></tr></table><button id="calcBtn" type="submit">Calculate!</button></form><br><p>The Area is <b id="areaResult">?</b></p><p>The Perimeter is <b id="periResult">?</b></p><script type="text/javascript" defer="">
      function main() {
      // Elements
      // Input
